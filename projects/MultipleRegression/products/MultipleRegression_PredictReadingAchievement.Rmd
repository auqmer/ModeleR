...
In this post I will use data from Pedhazur (1997), chapter 5, table 1 to model the use of verbal aptitude and achievement motivation to predict reading achievement.
...
mody.2 <- lm(y ~ x2)
mody.2 <- lm(y ~ x1 + x2)
htmlreg(list(mody.1, mody.2, mody.2),
